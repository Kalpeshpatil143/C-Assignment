...
namespace CustomAttribute
{
    ...
    public class SAttribute : System.Attribute  //Custom attribute
    {
        ...
        public SAttribute(String Pn,String Dn,String Cn,String Sd,String Ed)
        {
            this.projectName = Pn;
            this.description = Dn;
            this.clientName = Cn;
    ...
    [SAttribute("Hs management", "about hospital", "v3 solns", "12 / 8 / 2012" ,"12/10/2013")]
    [SAttribute("Industry management", "about Industries", "v5 solns", "25 / 5 / 2016", "30/01/2020")]
    class HDFCAccount
    {
        //member variables
    ...
    public class TestAttribute
    {
        static void Main(String[] args)
        {
            ...
            SAttribute customAttribute = new SAttribute("EMS", "it covers pf issues", "Infosys", "14/04/1995", "15/05/1999");
